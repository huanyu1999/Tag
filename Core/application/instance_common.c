...
extern tx_struct txSpeConfig[1];
// -------------------------------------------------------------------------------------------------------------------
//      Data Definitions
// -------------------------------------------------------------------------------------------------------------------
...
void instance_config(instanceConfig_t *config, sfConfig_t *sfConfig)
{
    ...
    inst->configData.phrMode = config->phrMode ;
    ...
    {
        power = txSpeConfig[0].txPwr[1];
    }

    //Configure TX power and PG delay
    inst->configTX.power = power;
    inst->configTX.PGdly = txSpeConfig[0].pgDelay ;
